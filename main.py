...
from reports.sensor_status import router as sensor_router
...
from reports.sensor_overview import router as sensor_overview_router 
...
app.include_router(sensor_overview_router)
